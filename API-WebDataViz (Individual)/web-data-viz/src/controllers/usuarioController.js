...
function cadastrar(req, res) {
    ...
    if (nome == undefined) {
        ...
        res.status(400).send("Seu personagem favorito está vazio!");
    } else if (dtNasc == undefined) {
        res.status(400).send("Sua data de nascimento vazia!")
    } else {
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrar(nome, email, senha, personagem, dtNasc)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
